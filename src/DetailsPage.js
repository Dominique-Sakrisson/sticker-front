...
export default class DetailsPage extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        await updateSticker(this.props.match.params.stickerId, this.state);

        this.props.history.push('/stickers');
    }
    handleDeleteClick = async () => {
        await deleteSticker(this.props.match.params.stickerId);
        this.props.history.push('/stickers');
    }
    ...
    render() {
        ...
        return (
            <div className='form-div'>
                ...
                <button onClick={this.handleDeleteClick}>Delete sticker</button>
            </div>
        )
    }
}